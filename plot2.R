...
## Since I want my plot2 graph to be in png format I am opening plot2.png file in my current
## working directory
png(file="plot2.png", width=480,height=480)

## A base graph would be plot using plot function from "data" with and weekday over x-axis and 
##"Global Active Power(Kilowatts)" in y-axis and this would be send to file plot2.png

plot(data$V3~data$V2,type="l",ylab="Global Active Power(Kilowatts)",xlab="",xaxt="n")
